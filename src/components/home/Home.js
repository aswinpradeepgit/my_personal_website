   ...
   return (
      <Box ref={innerRef} component={'main'} display={'flex'} flexDirection={{xs: 'column', md: 'row'}} alignItems={'center'}
         ...
         <Box>
            ...
            {/* <h2 style={{ whiteSpace: 'pre-line' }}>{info.position}</h2> (This line of code was initially used for h2*/}
            <h2 style={{ textAlign: 'left', lineHeight: '1.5' }}>
               I love building robust backend systems <br />
               <span style={{ paddingLeft: '0ch' }}>and </span>
               <span
                  style={{
